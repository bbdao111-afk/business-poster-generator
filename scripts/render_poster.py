...
"""
    ...
    body = f'<div class="poster"><div class="tech-grid"></div><div class="energy-line"></div><div class="content"><div class="brands">{left}<i class="divider"></i>{right}</div><h1 class="h1art">{campaign}</h1><div class="solutions">{solutions}</div></div>{hero_tag}<div class="hero-shade"></div><div class="hero-light"></div><div class="story"><div class="customer h1art">{e(d.get("customer"))}</div><div class="position">{e(d.get("customer_position"))}</div><p class="summary">{e(d.get("summary"))}</p>{qr_tag}</div></div>'
    return css, body
